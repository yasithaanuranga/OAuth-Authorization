...
Router.post('/access-token', (req, res) => {
    ...
    const otherParam = {
        ...
        body: `grant_type=authorization_code&code=${req.body.code}&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Flogin-callback&client_id=810a1fz735n4r5&client_secret=XBX5YPzAoP1S6exb`,
        method: "POST",
    };
